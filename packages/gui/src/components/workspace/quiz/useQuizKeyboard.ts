...
/*  non-quiz phase) are handled by the caller (onKeydown) before       */
 ...
 * caller before this function is reached. The caller is also responsible
 * for guarding against `isComplete` and non-quiz phases — this function
 * assumes those checks have already passed.
 *
